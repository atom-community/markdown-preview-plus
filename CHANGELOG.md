...
* Merge pull request #256 from atom/mq-coffeelint-plus (Machisté N. Quintana)
...
* :white_check_mark: Add specs (Thomas Johansen)
...
* Merge remote-tracking branch 'upstream/master' into 'master' (Edward Fauchon-Jones)
...
* Merge pull request #231 from howitzer-industries/hw-render-code-blocks-consistently (Kevin Sawicki)
* Prepare 0.147.0 release (Kevin Sawicki)
* Conditionally include deprecated APIs (Kevin Sawicki)
* Style <code> blocks consistently with GitHub.com Remove nowrap from the styling (Adam Montgomery)
...
* Merge pull request #222 from atom/jl-stop-scrolling-md-preview (Jessica Lord)
