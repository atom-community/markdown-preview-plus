...
var render = function(text, filePath, renderLaTeX, copyHTMLFlag, callback) {
...
var resolveImagePaths = function(html, filePath, copyHTMLFlag) {
  let rootDirectory;
...
var tokenizeCodeBlocks = function(html, defaultLanguage) {
  let fontFamily;
  if (defaultLanguage == null) { defaultLanguage = 'text'; }
  const doc = document.createElement('div');
  doc.innerHTML = html;
