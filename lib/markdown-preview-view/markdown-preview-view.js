    ...
    constructor(defaultRenderMode = 'normal', renderLaTeX = util_1.atomConfig().mathConfig
        ...
        this.renderPromise = new Promise((resolve) => {
            this.handler = new webview_handler_1.WebviewHandler(() => {
                this.handler.init(atom.getConfigDirPath(), util_1.atomConfig().mathConfig.numberEquations, util_1.atomConfig().mathConfig.mjxExtensions, util_1.atomConfig().mathConfig.mjxUndefinedFamily);
