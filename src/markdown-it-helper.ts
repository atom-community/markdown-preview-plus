...
const mathInline = (text: string) => `<span class='math'><script type='math/tex'>${text}</script></span>`;
const mathBlock = (text: string) => `<span class='math'><script type='math/tex; mode=display'>${text}</script></span>`;
